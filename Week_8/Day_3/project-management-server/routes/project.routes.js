...
router.post('/projects', async (req, res, next) => {
  try {
    ...
    if (!imageUrl) {
      imageUrl =
        'https://www.india.com/wp-content/uploads/2022/10/Untitled-design-2022-10-20T150640.003.jpg';
    }

    const newProject = await Project.create({ title, description, imageUrl });
